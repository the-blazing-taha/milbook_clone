    ...
    >
      <div className="text-white">
        ...
        <div className="row align-items-center mb-5">
          ...
          >
            <p>
              MILBOOK Rugged Tablets are available in a wide range of sizes from
              8 to 14-inches and support different systems to meet customers'
              diverse needs.
            </p>
            <p>
              Their outstanding features: large screen, carrier equipment,
              replaceable long-life battery, complete communication network
              support, adaptability to wireless situations make them an
              indispensable solution for people working in harsh conditions.
            </p>
            <p>
              Mainly used in automobile inspection, emergency, rescue and combat
              vehicles, chemical, petroleum, electric and other industries.
            </p>
          </div>
        </div>
